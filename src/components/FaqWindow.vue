<template>
    <v-row>
        <v-col cols="12">
            <v-expansion-panels>
                <v-expansion-panel v-for="(question, i) in questions" :key="i" :title="question.title">
                    <v-expansion-panel-text v-html="question.text" class="pa-5 ms-5"></v-expansion-panel-text>
                </v-expansion-panel>
            </v-expansion-panels>
        </v-col>
    </v-row>

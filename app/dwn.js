...
let agent = `Panthor Launcher/${app.getVersion()} (${os.type()} ${os.release()}; ${os.platform()}; ${os.arch()}) - `
...
const checkModCppSync = (basepath, mod) => {
  ...
  if (fs.existsSync(dest)) {
    ...
    if (!fs.existsSync(dest)) {
      let data = `dir="${mod.Directories}";${os.EOL}name="${mod.Name}";${os.EOL}picture="Panthor.paa";${os.EOL}actionName="Website";${os.EOL}action="https://panthor.de/";${os.EOL}description="${mod.Name}";`

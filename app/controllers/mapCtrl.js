angular.module('App').controller('mapCtrl', ['$scope', '$rootScope', ($scope, $rootScope) => {
  ...
  $scope.init = () => {
    ...
    let base = L.tileLayer('https://tiles.panthor.de/nordholm/map/{z}/{x}/{y}.png', {
      minZoom: 1,
      maxZoom: 6,
      attribution: '<a target="_blank" href="https://panthor.de">Havenborn Map by Panthor</a>',
      tms: true
    })
    let sat = L.tileLayer('https://tiles.panthor.de/nordholm/sat-dirt/{z}/{x}/{y}.png', {
      minZoom: 1,
      maxZoom: 6,
      attribution: '<a target="_blank" href="https://panthor.de">Havenborn Map by Panthor</a>',
      tms: true
    })
    let roads = L.tileLayer('https://tiles.panthor.de/nordholm/roads/{z}/{x}/{y}.png', {
      minZoom: 1,
      maxZoom: 6,
      attribution: '<a target="_blank" href="https://panthor.de">Havenborn Map by Panthor</a>',
      tms: true
